...
//y23m10d23// kxn comment here
char kxnfirmwareType[64+10]; // Biến thành viên có thể thay đổi
char kxnfwType[64 + 10]; // Biến thành viên có thể thay đổi
